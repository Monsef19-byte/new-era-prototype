...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        if check_password(pw):
            ...
            cookie = "ne_session={}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age={}".format(tok, SESSION_TTL)
            send_json(self, {"ok": True}, 200, cookie=cookie)
        else:
            send_json(self, {"ok": False, "error": "Mot de passe incorrect"}, 401)
